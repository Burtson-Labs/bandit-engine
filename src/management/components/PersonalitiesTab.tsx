      ...
      <Box sx={{ 
        ...
        <Box sx={{ 
          ...
          <Box sx={{
            ...
            <RocketLaunchOutlinedIcon sx={{ fontSize: { xs: "1.15rem", sm: "1.25rem" }, color: 'common.white' }} />
          </Box>
      ...
      >
        <CardContent sx={{
          ...
          <Box sx={{ 
            ...
            <AutoAwesomeIcon sx={{ fontSize: { xs: 24, sm: 28 }, color: 'common.white', filter: "drop-shadow(0 4px 12px rgba(0,0,0,0.25))" }} />
          </Box>
